...
class _SellScreenState extends ConsumerState<SellScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color backgroundTint =
        isDarkMode ? const Color(0xFF120A2A) : const Color(0xFFF3EEFA);
    final Color cardBackground =
        isDarkMode ? const Color(0xFF221A4A) : Colors.white;
    final Color textColor = isDarkMode ? Colors.white : Colors.black;
    final Color deepPurpleTheme =
        isDarkMode ? const Color(0xFF7B2FF7) : Colors.deepPurple;
    final Color fieldColor =
        isDarkMode ? const Color(0xFF1E163A) : Colors.white;
  ...
  Widget _buildImagePreview(String? existingImageUrl, Color deepPurpleTheme) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          "Add Photo",
          style: TextStyle(fontSize: 12, color: deepPurpleTheme),
        ),
      ],
    );
  }
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            isEditMode ? "Listing updated!" : "Listing published successfully!",
          ),
        ),
      );
